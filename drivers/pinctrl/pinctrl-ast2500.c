...
#define C12 16 /* GPIOC0 */
#define A12 17 /* GPIOC1 */
#define B12 18 /* GPIOC2 */
#define D9  19 /* GPIOC3 */
#define D10 20 /* GPIOC4 */
#define E12 21 /* GPIOC5 */
#define C11 22 /* GPIOC6 */
#define B11 23 /* GPIOC7 */
...
FUNC_EXPR_DECL_SINGLE(I2C11, FUNC_DESC_SET(SCU90, 23));
...
MS_PIN_DECL(C12, GPIOC0, SD1, I2C10);
MS_PIN_DECL(A12, GPIOC1, SD1, I2C10);

MS_PIN_DECL(B12, GPIOC2, SD1, I2C11);
MS_PIN_DECL(D9, GPIOC3, SD1, I2C11);

MS_PIN_DECL(D10, GPIOC4, SD1, I2C12);
MS_PIN_DECL(E12, GPIOC5, SD1, I2C12);

MS_PIN_DECL(C11, GPIOC6, SD1, I2C13);
MS_PIN_DECL(B11, GPIOC7, SD1, I2C13);
...
/* RGMII1/RMII1 */
#define B4 164 /* GPIOU4 */
#define A4 165 /* GPIOU5 */
#define A3 166 /* GPIOU6 */
#define D6 167 /* GPIOU7 */
#define C5 168 /* GPIOV0 */
#define C4 169 /* GPIOV1 */
#define B5 152 /* GPIOT0 */
#define E9 153 /* GPIOT1 */
#define F9 154 /* GPIOT2 */
#define A5 155 /* GPIOT3 */
#define E7 156 /* GPIOT4 */
#define D7 157 /* GPIOT5 */

#define RGMII1TX_DESC { SCUA0, GENMASK(5, 0), 0, GENMASK(5, 0) }
#define RGMII1RX_DESC { SCUA0, GENMASK(17, 12), 0, GENMASK(17, 12) }
FUNC_EXPR_DECL(RGMII1, RGMII1TX_DESC, RGMII1RX_DESC);
FUNC_EXPR_LIST_DECL(RGMII1, FUNC_EXPR_PTR(RGMII1));

#define RMII1TX_DESC { SCUA0, GENMASK(5, 0), 0, GENMASK(5, 0) }
#define RMII1RX_DESC { SCUA0, GENMASK(17, 12), 0, GENMASK(17, 12) }
FUNC_EXPR_DECL(RMII1, FUNC_DESC_BIT(STRAP, 6, 0), FUNC_DESC_BIT(SCU48, 1, 1));
FUNC_EXPR_LIST_DECL(RMII1, FUNC_EXPR_PTR(RMII1));

MS_PIN_DECL(B4, GPIOU4, RGMII1, RMII1);
MS_PIN_DECL_(A4, GPIOU5, FUNC_EXPR_LIST_PTR(RGMII1), NULL);
MS_PIN_DECL(A3, GPIOU6, RGMII1, RMII1);
MS_PIN_DECL(D6, GPIOU7, RGMII1, RMII1);
MS_PIN_DECL(C5, GPIOV0, RGMII1, RMII1);
MS_PIN_DECL(C4, GPIOV1, RGMII1, RMII1);
MS_PIN_DECL(B5, GPIOT0, RGMII1, RMII1);
MS_PIN_DECL(E9, GPIOT1, RGMII1, RMII1);
MS_PIN_DECL(F9, GPIOT2, RGMII1, RMII1);
MS_PIN_DECL(A5, GPIOT3, RGMII1, RMII1);
MS_PIN_DECL_(E7, GPIOT4, FUNC_EXPR_LIST_PTR(RGMII1), NULL);
MS_PIN_DECL_(D7, GPIOT5, FUNC_EXPR_LIST_PTR(RGMII1), NULL);
