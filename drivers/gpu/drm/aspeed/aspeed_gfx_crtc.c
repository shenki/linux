...
static void aspeed_gfx_enable_controller(struct aspeed_gfx *priv)
{
	...
	/* SCU2C: set DAC source for display output to Graphics CRT (aka GFX) */
...
static void aspeed_gfx_crtc_mode_set_nofb(struct aspeed_gfx *priv)
{
	...
	/*
	 * TODO
	 * Display Offset: the address difference between consecutive scan lines
	 * Terminal Count: the memory size of one scan line
	 */
